...
import Css from '../../Component/LandingWebsiteDev/LandingWebsiteDev.module.css';
import BG1 from '../../Assets/Web_bg.png';
        ...
        <div className={Css.LeftWrapper}>
          <div className={Css.MainDetails}>
            ...
            <div className={Css.ImageInfo}>
              <h1>
                Maximize <span className={Css.DifInfo}>your</span>
              </h1>
              <h1>
                business's <span className={Css.DifInfo}>digital</span>
              </h1>
              <h1>
                potential <span className={Css.DifInfo}>For</span>
              </h1>
              <h1>
                exponential <span className={Css.DifInfo}>growth</span>
              </h1>
            </div>
          </div>
          ...
          <div className={Css.BottomText}>
            <p>
              ...
              <span className={Css.TitleChange}>WEBSITE DEVELOPMENT</span>{' '}
              <span>COMPANY</span>
            </p>
          </div>
        </div>
