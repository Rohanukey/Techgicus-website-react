...
import Css from '../../Component/LandingLearning/LandingLearning.module.css';
import BG1 from '../../Assets/Learning_BG.png';
        ...
        <div className={Css.LeftWrapper}>
          <div className={Css.MainDetails}>
            ...
            <div className={Css.ImageInfo}>
              <h1>
                Become a <span className={Css.DifInfo}>web</span>
              </h1>
              <h1>
                <span className={Css.DifInfo}>developer</span>
              </h1>
              <h1>
               Web <span className={Css.DifInfo}>Development</span>
              </h1>
              <h1>
                Break<span className={Css.DifInfo}>down</span>
              </h1>
            </div>
          </div>
          ...
          <div className={Css.BottomText}>
            <p>
              ...
              <span className={Css.TitleChange}>Learning</span>{' '}
              <span>COMPANY</span>
            </p>
          </div>
        </div>
